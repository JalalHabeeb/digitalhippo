...
exports.appRouter = (0, trpc_1.router)({
    ...
    getInfiniteProduct: trpc_1.publicProcedure
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            var query, cursor, sort, limit, queryOpt, payload, parsedQueryOpts, page, _b, items, hasNextPage, nextPage;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        query = input.query, cursor = input.cursor;
                        sort = query.sort, limit = query.limit, queryOpt = __rest(query, ["sort", "limit"]);
                        return [4 /*yield*/, (0, get_payload_1.getPayloadClient)()];
                    case 1:
                        payload = _c.sent();
                        parsedQueryOpts = {};
                        Object.entries(queryOpt).forEach(function (_a) {
